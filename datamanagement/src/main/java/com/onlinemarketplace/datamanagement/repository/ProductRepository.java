...
public interface ProductRepository extends JpaRepository< Product,Long> {
	...
	public Product getByProperyNameAndValue( @Param("propertyName") String propertyName,@Param("propertyValue") String propertyValue );

	@Query("SELECT p FROM Product p JOIN p.productProperty pp WHERE pp.propertyName = :propertyName AND pp.propertyValue = :propertyValue")
	public Product getByProperyName( @Param("propertyName") String propertyName,@Param("propertyValue") String propertyValue );
	...
	public List<Product> getByCategoryAndSubCategoryAndPrice(@Param("cid") long cid,@Param("sid") long sid,@Param("min") float min,@Param("max") float max);
	...
	public List<Product> getByCategoryAndSubCategoryAndLPrice(@Param("cid") long cid,@Param("sid") long sid,@Param("min") float min,@Param("max") float max);
	...
	public List<Product> getByCategoryAndSubCategoryAndCPrice(@Param("cid") long cid,@Param("sid") long sid,@Param("min") float min,@Param("max") float max);
	...
	public List<Product> getByCategoryAandSubCategory(@Param("name") String name,@Param("cid") long cid,@Param("sid") long sid);
	...
	public List<Product> getByCategoryAndSubCategoryAndPrice(@Param("name") String name,@Param("cid") long cid,@Param("sid") long sid,@Param("min") float min,@Param("max") float max);
