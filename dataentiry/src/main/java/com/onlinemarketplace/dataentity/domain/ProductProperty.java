...
public class ProductProperty extends AbstractEntity  {
	...
	public String toString() {
		return "ProductProperty [product=" + product + ", propertyName=" + propertyName + ", propertyValue="
				+ propertyValue + "]";
	}
	...
	public static String toString(List<ProductProperty> properties){
		...
		if(properties != null){
			for (ProductProperty productProperty : properties) {
				buffer.append(productProperty.propertyName+"="+productProperty.propertyValue);
				buffer.append("/");
			}
		}
