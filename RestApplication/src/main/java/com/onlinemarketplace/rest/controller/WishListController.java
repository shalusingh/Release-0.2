...
public class WishListController {
    ...
    public Response<WishList> getWishList(HttpSession session) {
        ...
        try {
            List<WishList> wishLists = repository.findByCustomer(customer.getId());
    ...
    public Response<WishList> addWishList(@RequestParam("productId") long productId, HttpServletRequest request,
        HttpSession session) {
        Response<WishList> response = new Response<WishList>();
